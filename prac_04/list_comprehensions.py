...
lowercase_full_names = str(full_names).lower()
...
greater_numbers = [int(numbers) for numbers in numbers if numbers > 9]
...
greater_names = [str(full_names) for full_names in full_names if not len(full_names) <= 11]
